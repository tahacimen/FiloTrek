...
export default async function LoginPage({
  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      ...
      <div className="relative hidden overflow-hidden bg-[#0d2a63] lg:flex lg:flex-col lg:justify-center lg:p-16">
        <div className="absolute inset-0 bg-[repeating-linear-gradient(115deg,#12306e,#12306e_26px,#15366f_26px,#15366f_52px)]" />
        <div className="absolute inset-0 bg-[linear-gradient(160deg,rgba(13,42,99,0.55),rgba(13,42,99,0.9))]" />
        ...
        <div className="relative max-w-[420px]">
          <div className="mb-7 inline-flex items-center gap-2 rounded-full bg-white/12 px-4 py-2 text-[13px] font-semibold text-white">
            <Radio className="size-[15px] text-[#ef9a5e]" />
            ...
            {FEATURES.map((f) => (
              <div key={f.title} className="flex items-center gap-3.5 text-white">
                <span className="flex size-11 shrink-0 items-center justify-center rounded-xl bg-white/12">
                  <f.icon className="size-[22px] text-[#ef9a5e]" />
                </span>
                <div>
